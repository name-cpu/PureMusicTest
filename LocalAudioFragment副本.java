...
public class LocalAudioFragment extends Fragment implements ViewPager.OnLongClickListener, ViewPager.OnPageChangeListener
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAllSongAdapter = new AudioListViewAdapter(this.getActivity(), AudioListViewAdapter.ADAPTER_TYPE_ALLSONG, true);
        ...
        mSongFolderAdapter = new AudioListViewAdapter(this.getActivity(), AudioListViewAdapter.ADAPTER_TYPE_FOLDER, false);
        ...
        mArtistAdapter = new AudioListViewAdapter(this.getActivity(), AudioListViewAdapter.ADAPTER_TYPE_ARTIST, false);
        ...
        mAlbumAdapter = new AudioListViewAdapter(this.getActivity(), AudioListViewAdapter.ADAPTER_TYPE_ALBUM, false);
