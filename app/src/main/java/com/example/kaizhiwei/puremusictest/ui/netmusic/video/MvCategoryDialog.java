...
public class MvCategoryDialog extends BaseDialog implements View.OnClickListener {
    ...
    public MvCategoryDialog(@NonNull Context context) {
        super(context);
    }

    public MvCategoryDialog(@NonNull Context context, @StyleRes int themeResId) {
    ...
    private class MvCategoryIndexAdapter extends RecyclerView.Adapter<MvCategoryViewHolder>{
        ...
        public MvCategoryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(MvCategoryDialog.this.getContext()).inflate(R.layout.item_artist_index, parent, false);
    ...
    public static class Builder extends BaseDialog.Builder{
        ...
        public <T extends BaseDialog> T createDialog() {
            return (T) new MvCategoryDialog(mContext);
        }
